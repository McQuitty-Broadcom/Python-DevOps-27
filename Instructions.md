...
- Your login: is mfwsuser27@demo.broadcom.com
...
- Your userid is CUST027.
- Your password CUST027.
...
- Run the following commands and ensure we get a 0000 return code:
  - `zowe endevor generate DOGGOS27 --type COBOL --os --maxrc 0 --sn 1 --cb`
  - `zowe endevor generate DOGGOS27 --type LNK --os --maxrc 0 --sn 1 --cb`
...
- To execute the application and see the output, we can call `zowe jobs`.
  - `zowe jobs submit dataset CUST027.PUBLIC.JCL(NDRUNDOG) --vasc`
...
`zowe jobs submit data-set "CUST027.MARBLES.JCL(MARBCOPY)" --vasc`
...
Username: _JENKINSCUST027
Password: Mfuser27@26
...
The repository URL will be `https://github.com/McQuitty-Broadcom/Python-DevOps-27.git`
